...
public class OtherTest {
    ...
    public void test1(){
        ...
        //getConstructors():获取当前运行时类中public的构造器拿不到父类的构造器
...
//        System.out.println(actualTypeArguments[0]);//class java.lang.String
    ...
    public void test5(){
        ...
        //获取运行时类的父类实现的接口
        System.out.println("获取运行时类的父类实现的接口：");
    ...
    public void test6(){
        Class clazz = Person.class;
        Package packs = clazz.getPackage();
