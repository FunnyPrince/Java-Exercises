...
public class ReflectionTest {
    ...
    public void testField() throws Exception {
        ...
        //获取指定的属性：要求运行时类的属性生命为public，如name，age就不可获取
        //通常不采用此方法
        Field id = clazz.getField("id");
        //
        /*设置当前属性的值

        set():参数1：指明设置哪个对象的属性  参数2：将此属性值设置为...
         */
        id.set(p,1001);
        /*
        获取当前属性的值
    ...
    public void testConstructor() throws Exception {
        ...
        //3.调用此构造其创建运行时类的对象
//        Object per = constructor.newInstance("Yummy");
        Person per = (Person)constructor.newInstance("Yummy");
